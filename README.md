# Trace Formula Endoscopy — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/trace-formula-endoscopy-canonical-lane-mathlib.git
cd trace-formula-endoscopy-canonical-lane-mathlib
lake exe
lake build
```
